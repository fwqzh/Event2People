    ...
    vi.mocked(fetchArxivPapers).mockResolvedValue([
      {
        ...
        pdfTextRaw: "Full paper text for Embodied Planning Kernel.",
        authorEmailsRaw: ["alice@stanford.edu"],
        citationCount: 0,
            ...
            paperLinks: [
              {
                paper: {
                  ...
                  pdfTextRaw: "Full cached robotics paper text.",
                  codeUrl: null,
                  authorEmailsRaw: ["bob@shlab.org"],
