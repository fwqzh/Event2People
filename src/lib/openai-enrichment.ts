        ...
        messages: [
          {
            ...
            content: [
              ...
              `如果 sourceType 是 kickstarter，eventTitleZh 必须直接写 campaign 名，最长 ${EVENT_TITLE_LIMIT} 个中文字符。`,
              `如果 sourceType 是 kickstarter，eventHighlightZh 必须用一句中文概括产品做什么，最长 ${EVENT_HIGHLIGHT_LIMIT} 个中文字符。`,
              "Kickstarter 的 eventDetailSummaryZh 需要直接解释这是一个什么产品、面向什么场景，以及当前众筹状态，不要写空泛评价。",
              ...
              "如果 sourceType 是 arxiv，eventDetailSummaryZh 必须是一句通俗易懂的中文，直接解释这篇论文在做什么或解决什么问题，让非研究员也能快速看懂。",
              "arxiv 的 eventDetailSummaryZh 不要写“研究入口”“值得跟进”“人物关系”“实现关系”“论文发布”这类模板话，也不要只重复标题。",
